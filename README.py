...
Health regain increases as streak increases
...
Basic Features:
User Input: user inputs arrows corresponding to the ones on screen
Game Over: games ends when health drops to 0
Graphics: Arrows dropping down will be different colored graphics

Additonal Features:
Health Bar
Inter-session Progress
Timer Score
Additional - health increases with displayed streak
"""